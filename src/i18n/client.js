...
const translations = {
  en: {
    translation: {
      ...
      personalizedDesc:
        "Customize your avatar to match your vibe with limitless expressions, emotes, and accessories.",
      ...
      artGallerySubHeading:
        "Explore immersive digital art in our virtual lobby.",
      lobbyHeading: "Lobby",
      lobbySubHeading: "Welcome to a modern and elegant digital space.",
      conferenceRoomHeading: "Conference Room",
      conferenceRoomSubHeading:
        "Collaborate with teams in a futuristic environment.",
      ...
      copyright: "COPYRIGHT BY @ ZOAVERSE - 2026",
      unsupportedTitle: "Unsupported Platform",
      unsupportedDesc:
        "It looks like your device isn’t supported for automatic download. Please choose your version manually below:",
    },
  },
  ar: {
    translation: {
      ...
      conferenceDesc:
        "استضف فعاليات احترافية داخل قاعة ثلاثية الأبعاد أنيقة مصممة للجماهير الكبيرة. تفاعل مع الحضور بعروض مباشرة، جلسات نقاش، ودعم لغات متعددة لتجربة شاملة",
      podcastHeader: "البودكاست",
      podcastDesc:
        "انقل صوتك إلى عالم غامر داخل استوديو ثلاثي الأبعاد. حوّل برامجك الصوتية إلى جلسات تفاعلية بديناميكية بصرية جذابة، متاحة على الكمبيوتر وقريبًا على الجوال",
      galleryHeader: "المعرض",
      galleryDesc:
        "اعرض أعمالك الفنية أو منتجاتك أو أفكارك داخل معارض ثلاثية الأبعاد قابلة للتخصيص. من المعارض المؤسسية إلى العروض الإبداعية، صمم مساحتك بما يعكس علامتك ورؤيتك",
      classroomHeader: "القاعة التعليمية",
      classroomDesc:
        "حوّل التعلم إلى تجربة تفاعلية مشوقة. مزودة بلوحات تفاعلية افتراضية وأدوات تعاون واتصال لحظي تجعل التعليم أكثر جاذبية وسهولة",
      lobbyHeader: "الردهة",
      lobbyDesc:
        "مركزك الرئيسي للتواصل والتعارف. التَقِ، وتحدث، وتصفح بسهولة داخل مساحة بصرية مبهرة مصممة لتسهيل الانضمام وبناء المجتمعات",
      gesturesHeader: "الإيماءات",
      gesturesDesc:
        "عبّر عن نفسك بحركات وإيماءات تفاعلية ممتعة. من الرقصات الاحتفالية إلى الحركات الغريبة، اجعل شخصيتك تنبض بالحياة",
      backDecoHeader: "الزخارف الخلفية",
      backDecoDesc:
        "تميّز بإضافات فريدة مثل الأجنحة والدروع والأدوات المستقبلية التي تضيف لشخصيتك حضورًا وتأثيرًا مميزًا",
      companionsHeader: "الرفقاء",
      companionsDesc:
        "تبنَّ رفيقًا افتراضيًا يشاركك رحلتك في زوافيرس. اختر من مجموعة من المخلوقات اللطيفة أو الروبوتات الجريئة التي تضيف متعة لكل لحظة",
      headwearHeader: "الإكسسوارات الرأسية",
      headwearDesc:
        "زيّن شخصيتك الافتراضية بإكسسوارات مرحة أو أنيقة أو جريئة. من القطع اللطيفة إلى التصاميم المميزة، عبّر عن أسلوبك بحرية",
      round3AlphaHeader: "راوند٣ - ألفا",
      round3AlphaDesc:
        "ادخل ساحة قتال مستقبلية حيث تتواجه الروبوتات مع الجنود المدرّعين. تجربة مليئة بالإثارة تجمع بين الاستراتيجية والبقاء والتقنية المتقدمة",
      zeroIqHeader: "Zero IQ",
      zeroIqDesc:
        "أطرف عرض مسابقات تفاعلي ستجربه! فريقان يتنافسان للإجابة على أسئلة غريبة ومضحكة في أجواء مليئة بالحماس والضحك",
      round3QurtobaHeader: "راوند٣ - قرطبة",
      round3QurtobaDesc:
        "تجربة مستوحاة من المدن العربية القديمة في لعبة “Prop & Hunt”. اختبئ، طارد، واهزم خصومك في بيئة غنية تجمع بين التراث والإثارة",

      expressYourUnique: "عبّر عن",
      identity: "هويتك المميزة",
      avatarDescription:
        "أظهر شخصيتك الحقيقية مع خيارات تخصيص لا محدودة. من الإكسسوارات الفريدة والتيجان العصرية إلى الإيماءات المعبرة والرفقاء المميزين، يمنحك “زوافيرس” كل الأدوات التي تحتاجها لتبرز بأسلوبك الخاص",
      personalized: "الهوية الفريدة",
      personalizedDesc:
        "خصص شخصيتك الافتراضية لتناسب أسلوبك ومزاجك من خلال تعابير وإيماءات وإكسسوارات لا حصر لها.",
      companions: "الرفقاء",
      companionsDescri:
        "من المخلوقات المرحة إلى الروبوتات المستقبلية، هم أكثر من مجرد إكسسوارات — إنهم جزء من رحلتك داخل العالم الافتراضي",
      ...
      now: "الآن",
      newsDescription:
        "ابقَ على تواصل مع الفعاليات الحية داخل زوافيرس. من المؤتمرات وورش العمل إلى الحفلات والاجتماعات المجتمعية، دائمًا هناك حدث شيّق بانتظارك!",

      event1_title: "اسم الفعالية",
      event1_day: "الاثنين",
      event1_desc:
        "زوافيرس تقدّم مجموعة واسعة من القاعات القابلة للتخصيص لتجعل تجربتك مميزة ومتفردة.",
      ...
      event2_day: "الأربعاء",
      event2_desc:
        "نافس لاعبين من جميع أنحاء العالم في بطولتنا الحصرية للألعاب.",
      ...
      event3_day: "الجمعة",
      event3_desc:
        "انضم إلى ورشتنا التفاعلية لتتعلم مهارات جديدة وتتعرف على أشخاص ذوي اهتمامات مشتركة.",
      ...
      copyright: "جميع الحقوق محفوظة @ ZOAVERSE - 2026",
      unsupportedTitle: "منصة غير مدعومة",
      unsupportedDesc:
        "يبدو أن جهازك غير مدعوم للتنزيل التلقائي. يُرجى اختيار إصدارك يدويًا أدناه:",
    },
  },
};
